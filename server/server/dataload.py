...
# Import App models and serializers here to include in the data load/save functionality.
# For each App add
#from <app_name>.models import model_name_map as <app_name>_model_name_map
...
def save_data_to_folder(data_folder: str):
    ...
    for app_to_save in model_name_map.keys():
        ...
        for model_to_save in model_name_map[app_to_save].keys():
            ...
            # Sort by id to avoid dependency issue on self-referencing models
            model_records = model_class.objects.all().order_by('id')
